...
import com.ccj.ioc.annotation.ListenEvent;
			...
			for (Annotation annotation : annotations) {
				...
				try {
					...
					for (int viewId : viewIds) {
						...
						//而setListener方法是View的方法,此处该view是继承View,so 用getMethod才能得到.
						Method setListenerMethod = view.getClass().getMethod(setListener, listenerType);
